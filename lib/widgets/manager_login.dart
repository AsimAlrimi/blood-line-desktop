...
import 'package:blood_line_desktop/services/login_logic.dart'; // Import the login logic
import 'package:flutter/material.dart';

class ManagerLogin extends StatefulWidget {
  final String userType;

  ManagerLogin({required this.userType});
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          ...
                          CustomButtonLoginpage(
                            ...
                            onPressed: () {
                              Navigator.pushNamed(context, AppRoutes.requistRegisterationPage);
                            },
