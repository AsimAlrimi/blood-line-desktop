...
class AdminSidebar extends StatelessWidget {
  ...
  AdminSidebar({required this.onItemTapped, required this.selectedIndex});
        ...
        Flexible(
          child: ListView(
            children: [
              ...
              buildMenuItem(icon: Icons.app_registration_outlined, title: "Requests", index: 1),
              buildMenuItem(icon: Icons.question_answer, title: "FAQ", index: 2),
